...
| P9 re-vendor v1.59.0 + X button | CX-3 | AM | P8, P7 | done | 2abe552 + this commit | re-vendor v1.59.0 (WidgetsDragHandle 3, bundle docs/revendor/2026-09-25-v1.59.0); BuildHandle passes closeIcon/onClose/closeTooltip, X disables via NS.SetByPath + one chat line; test_anchors_close suite; RESERVE2 58->94 |
