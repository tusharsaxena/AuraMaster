...
| P12 docs sync + full battery | all | AM | P11 | done | this commit | test-cases regenerated (1470); counts re-verified live (schema 255: Filters 46, Layout 35, Text 37; 50 files; 22 commands/shims; 4 messages); schema.md label block + 8 whole sections; settings-panel Name label + dispel strips; module-map suite order + seam/label suites; data-flow seam/label/X/autosize; known-limitations X/label/autosize/diag; README badge + X/label/Size to fit/diag; smoke section Z (197-208 + item index, owner to run); battery green |
