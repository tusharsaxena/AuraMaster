...
**Current position (2026-09-20):** all tasks done, owner follow-ups A and B (rows 14-15) and item B2-3 (row 16) included. Awaiting the owner's go-ahead to merge `feat/smoke-feedback-2` and push, and the in-game checks in `docs/smoke-tests.md` section U (143-161).
