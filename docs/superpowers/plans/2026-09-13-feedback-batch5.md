...
| D3 Spell Categories + Dispel Colors | G-2 G-3 | AM | done | e697a4f | IdList over profile categorySpells; dispel rows on General; Filters Spell lists tab gone; bespoke tab `before` |
