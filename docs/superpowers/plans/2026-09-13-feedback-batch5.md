...
| H1e host-kind base hook (CM rank icons) | X-1 X-4 | AM | done | LibKa0s 45e035e ebd51a8 6036c26; AM 2a3f63e | re-vendor v1.35.0 re-cut (tag moved 80b8d15 -> 6036c26): a host kind's `base = "item"/"spell"/"currency"` inherits the base kind's decorations; only OptionsWidgets.lua changed, stub and kit unchanged; AM passes library kinds only, no adoption change; 813/0, luacheck 0/0, 0 over CCN 15 |
