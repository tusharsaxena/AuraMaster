...
| `styleElement` | — | `modules/Style.lua:474-482` | Dressing one bar or icon: called by the engine's `initializeFrame` as it creates buttons, by a restyle, and by the preview |
