...
| `applyPass` | — | `modules/ContainerManager.lua:324-328` | The coalesced pass applying pending configuration to every dirty container, plus re-placing container-attached ones |
...
| `visibilityPass` | — | `modules/ContainerManager.lua:345` | The show ladder over every container, on combat transitions, world entry and the master rows |
