...
| `styleElement` | — | `modules/Style.lua:389-397` | Dressing one bar or icon: called by the engine's `initializeFrame` as it creates buttons, by a restyle, and by the preview |
