...
| `styleElement` | — | `modules/Style.lua:483-491` | Dressing one bar or icon: called by the engine's `initializeFrame` as it creates buttons, by a restyle, and by the preview |
