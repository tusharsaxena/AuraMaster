...
| `styleElement` | — | `modules/Style.lua:519-527` | Dressing one bar, icon or line of text: called by the engine's `initializeFrame` as it creates buttons, by a restyle, and by the preview |
