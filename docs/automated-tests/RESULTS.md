...
**1350 cases** — 1350 passed, 0 failed, 0 skipped. The generated inventory
[`20260924-185738/test-cases.md`](20260924-185738/test-cases.md) is the authority on which cases existed at this run;
`docs/test-cases.md` is that same list at HEAD.

Moved **943 → 1350** since the previous run.
...
[`20260924-185738/perf.json`](20260924-185738/perf.json).

| `scenario` | `iters` | `ms/iter` | `api/iter` | `bytes/iter` |
|---|---|---|---|---|
| `compile` | 2000 | 0.03963 | 0.0 | 22200.0 |
| `applyPass` | 200 | 0.83800 | 30.0 | 118147.2 |
| `restyle` | 200 | 0.30290 | 0.0 | 51479.9 |
| `restyleText` | 200 | 0.17681 | 0.0 | 30960.6 |
| `visibilityPass` | 1000 | 0.00861 | 4.0 | 384.0 |
| `unitSwap` | 1000 | 0.00094 | 1.0 | 0.0 |
| `probeOverheadOff` | 1000 | 0.00967 | 5.0 | 384.0 |
| `probeOverheadOn` | 1000 | 0.01077 | 5.0 | 384.5 |
| `probeAbsent` | 1000 | 0.00992 | 5.0 | 384.0 |
| `unitAuraFiltered` | 1000 | 0.00021 | 0.0 | 0.0 |
...
Current as of [`20260924-185738`](20260924-185738/) — **this run's measurement, not its diff.** Max CCN **15** across 3492
