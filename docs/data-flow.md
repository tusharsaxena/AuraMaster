...
```
 1  a control, /am set, a Defaults button or a drag handle
        │  NS.SetByPath(path, value[, containerId])            settings/Schema.lua:440
        ...
        ▼
 2  ContainerManager (listener)                                modules/ContainerManager.lua:478
 ...
 3  ContainerManager.FlushPending                              modules/ContainerManager.lua:214
        ...
        ▼
 4  Container:Apply                                            modules/Container.lua:297
...
signatures differ (`modules/Container.lua:251-253`), because the engine clears and re-gathers a
...
`SetUnit` last (`modules/Container.lua:169`).
