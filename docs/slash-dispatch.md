...
`format` hook (`formatValue`, `settings/Slash.lua:438`) does it; every other row prints as the
library formats it.
...
With `LibKa0s-Slash-1.0` absent, `settings/Slash.lua:359` builds a stub dispatcher: the host verbs
