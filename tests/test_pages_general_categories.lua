...
-- case clicks something.

local T = _G.AM_TEST
local test, assertEqual, assertTrue, assertFalse, assertNil =
    T.test, T.assertEqual, T.assertTrue, T.assertFalse, T.assertNil
local H = dofile("tests/general_page_helpers.lua")
local spells, YOURS_COLOR, marked, ownedName, entry, entryTooltip, entryHelp, entryHelpTint,
    starterIds, spyPaths =
    H.spells, H.YOURS_COLOR, H.marked, H.ownedName, H.entry, H.entryTooltip, H.entryHelp,
    H.entryHelpTint, H.starterIds, H.spyPaths
